    ...
    $.ajax({
        ...
        success: data => {
            ...
            hitlist.songs.map((s, index) => {
                ...
                grid_container_voting.setAttribute('class', 'grid-container-edit')
                ...
                grid_container_voting.appendChild(checkSong)
...
function deleteAllSongs(){
    ...
    $.ajax({
        ...
        success: () => {
            Swal.fire({
                title: 'Successfully deleted all songs!',
                icon: 'success',
                iconColor: "#569429",
                timer: 10000,
                timerProgressBar: true,
...
/* Am gonna transfer the ones below to a new file -Bernice */
